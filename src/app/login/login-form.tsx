...
export function LoginForm() {
  ...
  return (
    <div className="glass-panel rounded-2xl p-6">
      ...
      <button
        type="button"
        className="w-full rounded-2xl border border-white/35 bg-white/25 px-4 py-2.5 text-sm font-medium text-slate-800 hover:bg-white/40 dark:border-slate-400/45 dark:bg-slate-800/70 dark:text-slate-50 dark:hover:bg-slate-700/60"
